...
func buildActionRegistry() map[string]ActionSpec {
	specs := []ActionSpec{
		...
		{Name: "window_floating", Description: "toggle active window floating", Handler: ToggleWindowFloating},
		{Name: "window_float", Description: "float active window", Handler: EnableWindowFloating},
		{Name: "window_tile", Description: "tile active window", Handler: DisableWindowFloating},
